ServerEvents.recipes(event => {
  ...
  // ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Angel Rings Reimagined

  event.remove({mod:'extrautils2'})
  event.shaped(
    Item.of('extrautils2:angelring_golden', 1),
    [
      'CCC',
      'CAC',
      'CCC'
    ...
    {
      A: 'avaritia:infinity_elytra',
      C: 'creativewirelesstransmitter:creative_wireless_transmitter'
    }
  )
  ...
  event.remove({id:'debugstick:debug_stick'})
  event.shaped(
    Item.of('minecraft:debug_stick', 1),
    [
      'CBC',
      'BAB',
      'CBC'
