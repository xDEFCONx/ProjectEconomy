...
3) Navigate to your .minecraft directory, commonly found at `C:\Users\[USER]\Appdata\Roaming\.minecraft`, and drop the .zip into it. (Note: You can type %appdata% into your start menu's search bar to quickly access it.)
